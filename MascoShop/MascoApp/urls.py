...
from .views import form_del_producto, form_producto, home,somos,registrar,galeria,feriados,form_modproducto,form_del_producto,mostrar,ejemplo,mostrar_cliente,form_del_cliente,form_cliente,form_modcliente,form_del_cliente,api
